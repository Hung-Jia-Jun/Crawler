...
OutputJson="["
Write_txt=Write_txt("C:/Python27/Scripts/Crawler_Volkswagen/Crawler_Porsche/City_result.txt")
Write_txt.Write_Action("[")
Text_str=Read_txt("C:/Python27/Scripts/Crawler_Volkswagen/Crawler_Porsche/City.txt")
